...
- **Picek, L.**, et al. (2025). GeoPl@ntNet: A Platform for Exploring Essential Biodiversity Variables. In *Proceedings of the European Conference on Artificial Intelligence*. ([Pl@ntBERT used in a platform for exploring habitats distribution predictions](http://doi.org/10.3233/FAIA251430))
